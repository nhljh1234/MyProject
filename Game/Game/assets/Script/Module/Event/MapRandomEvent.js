...
local.eventFuncObj.battle = function (personData, dataArr) {
    g_BattleManager.startBattle(personData, _g_require('PersonFactory').createOneBasePerson(dataArr[0], undefined, undefined));
};

//判断会不会有随机事件
outModule.judgeMapRandomEvent = function (personData) {
    if (cc.random0To1() >= (g_GlobalData.MAP_RANDOM_EVENT_RECORD / 100)) {
        return;
    }
