...
window.Global.GameScene.UINode = undefined;
window.Global.GameScene.AlertNode = undefined;
window.Global.GameScene.NetNode = undefined;

window.Global.init = function () {
    window.Global.PrefabManager.init();
    window.Global.SpriteFrameManager.init();
};