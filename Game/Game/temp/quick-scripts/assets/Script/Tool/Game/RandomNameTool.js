(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/Tool/Game/RandomNameTool.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'df5a0DVP7xHoqfqHdqvfxKF', 'RandomNameTool', __filename);
// Script/Tool/Game/RandomNameTool.js
 ...
 * @param name
 */
outModule.removeOneName = function (name) {
    var index = allNameArr.indexOf(name);
    if (index >= 0) {
 ...
 * @param sex 性别
 */
outModule.getRandomName = function (sex) {
    var surname = SURNAME_ARR[Math.floor(cc.random0To1() * SURNAME_ARR.length)];
    var name = void 0;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=RandomNameTool.js.map
