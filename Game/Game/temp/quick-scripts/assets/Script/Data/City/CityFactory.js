(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/Data/City/CityFactory.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'a48fffbGV5CIIrdM/XLLBl9', 'CityFactory', __filename);
// Script/Data/City/CityFactory.js
...
local.buildFunc = function (city) {
    ...
    city.getBuildingById = function (buildingId) {
        return this._buildingArr.find(function (oneBuildingData) {
...
local.createOneCityBySaveData = function (saveData) {
    ...
    //人物列表
    //表示家在这个城市的人
    this._personArr = saveData.personArr.map(function (personId) {
        return g_GameGlobalManager.gameData.getPersonById(personId);
    });
    //建筑列表
    this._buildingArr = ('' + jsonData.building).split(',').map(function (buildingId) {
...
local.createOneCity = function (cityId) {
    ...
    //人物列表
    this._personArr = ('' + jsonData.npc).split(',').map(function (personId) {
        return PersonFactory.createOneBasePerson(personId, undefined, _this._id);
    });
    //随机人物
    for (var i = 0; i < jsonData.randomNpcNum; i++) {
 ...
 * @param saveData 
 */
outModule.createOneCity = function (cityId, saveData) {
    if (saveData) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=CityFactory.js.map
