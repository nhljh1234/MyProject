(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/Data/Item/SellGoodFactory.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'dfff6sY2mhOooBdhVL+3UIL', 'SellGoodFactory', __filename);
// Script/Data/Item/SellGoodFactory.js
...
local.useSellGoodFunc.treat = function (person, sellGood, index) {
    var numArr = sellGood._functionNumArr[index];
...
local.buildFunc = function (sellGood) {
     ...
     * 每天的更新函数
     */
    sellGood.dayUpdate = function (personData) {
     ...
     * 使用物品
     */
    sellGood.use = function (personData) {
     ...
     * 出售物品
     */
    sellGood.sell = function (personData) {
 ...
 * @param saveData 存储的数据
 */
outModule.createOneSellGood = function (sellGoodId, saveData, personData) {
    if (saveData) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=SellGoodFactory.js.map
