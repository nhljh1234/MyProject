(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/UI/UserBuildUI/UserBuildUI.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'd3a91FBs0BBHruCLclyQnzo', 'UserBuildUI', __filename);
// Script/UI/UserBuildUI/UserBuildUI.js
...
cc.Class({
    ...
    onButtonClick: function onButtonClick(name, node, component) {
        switch (name) {
            case 'random_btn':
                ...
                break;
            case 'random':
                this._randomUserRoleData = UserRoleFactory.createUserRole(undefined, UserRoleFactory.getRandomUserRoleData(this._randomSex, this._randomName));
                this.updateRandomNum(this._randomUserRoleData);
                break;
            case 'sure':
                g_GameGlobalManager.userRole = this._randomUserRoleData;
                //加载MainUI界面
                g_GameSceneManager.addNode('Prefab/MainUI/MainUI', g_GAME_SCENE_UI_NODE, 'MainUI', false, undefined, undefined, 100);
                //直接销毁了，这个界面没用了
                this.hide(true);
                break;
        }
     ...
     * @param randomName
     */
    updateRandomName: function updateRandomName(randomName) {
     ...
     * @param randomData
     */
    updateRandomNum: function updateRandomNum(randomData) {
     ...
     */
    updateSexToggle: function updateSexToggle(selectSex) {
        ...
        //更新显示字符
        cc.find('Sex/random_sex', this._topNode).getComponent(cc.Label).string = selectSex === g_GlobalData.SEX_MAN ? g_LanguageTool.getLanguageStr('sex_man') : g_LanguageTool.getLanguageStr('sex_woman');
    }
});
...
cc._RF.pop();
        ...
        //# sourceMappingURL=UserBuildUI.js.map
