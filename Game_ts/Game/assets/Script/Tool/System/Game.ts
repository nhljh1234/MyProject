...
class Game {
    ...
    BUILDING_TYPE_HOTEL = 'hotel';

    BUILDING_FUNCTION_TYPE_COME_BACK = 'comeBack';
    BUILDING_FUNCTION_TYPE_REST = 'rest';
    BUILDING_FUNCTION_TYPE_WAREHOUSE = 'warehouse';
    BUILDING_FUNCTION_TYPE_COMMAND = 'command';
    BUILDING_FUNCTION_TYPE_FISH = 'fish';
    BUILDING_FUNCTION_TYPE_HUNT = 'hunt';
    BUILDING_FUNCTION_TYPE_TREAT = 'treat';
    BUILDING_FUNCTION_TYPE_TRAVEL = 'travel';
    BUILDING_FUNCTION_TYPE_TRADE = 'trade';
    BUILDING_FUNCTION_TYPE_HIRE = 'hire';
