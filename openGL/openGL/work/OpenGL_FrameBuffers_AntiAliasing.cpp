...
int main()
{
	...
	*/
	...
	//新建一个空的纹理
	unsigned int nullMultiSampledTextureID = getNullMultiSampledTexture(SCR_WIDTH, SCR_HEIGHT);
	//附加到帧缓存上
	//第一个参数：
	...
	glFramebufferTexture2D(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_2D_MULTISAMPLE, nullMultiSampledTextureID, 0);
	//附加深度缓冲纹理
	...
	unsigned int screenTexture = getNullTexture(SCR_WIDTH, SCR_HEIGHT);
