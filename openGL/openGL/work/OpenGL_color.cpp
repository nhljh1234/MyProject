...
int main()
{
	...
	std::string vsPath = "./work/ShaderFile/Color/lamp/vertex.vs";
	std::string fsPath = "./work/ShaderFile/Color/lamp/fragment.fs";
	MyShader lampShader(vsPath.data(), fsPath.data());

	vsPath = "./work/ShaderFile/Color/toy/vertex.vs";
	fsPath = "./work/ShaderFile/Color/toy/fragment.fs";
