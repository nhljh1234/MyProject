...
int main()
{
	...
	std::string vsPath = "./work/ShaderFile/LightingMaps/lamp/vertex.vs";
	std::string fsPath = "./work/ShaderFile/LightingMaps/lamp/fragment.fs";
	MyShader lampShader(vsPath.data(), fsPath.data());

	vsPath = "./work/ShaderFile/LightingMaps/toy/vertex.vs";
	fsPath = "./work/ShaderFile/LightingMaps/toy/fragment.fs";
