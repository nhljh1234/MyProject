...
int main()
{
	...
	std::string vsPath = "./work/ShaderFile/LightingCasters_1/lamp/vertex.vs";
	std::string fsPath = "./work/ShaderFile/LightingCasters_1/lamp/fragment.fs";
	MyShader lampShader(vsPath.data(), fsPath.data());

	vsPath = "./work/ShaderFile/LightingCasters_1/toy/vertex.vs";
	fsPath = "./work/ShaderFile/LightingCasters_1/toy/fragment.fs";
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//修改成平行光
		glUniform3f(glGetUniformLocation(toyShader.ID, "light.direction"), -0.2f, -1.0f, -0.3f);
		model = glm::mat4(1.0f);
