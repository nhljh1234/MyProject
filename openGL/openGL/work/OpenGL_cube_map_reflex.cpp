...
int main()
{
	...
	//着色器
	std::string vsPath = "./work/ShaderFile/CubeMap/CubeReflect/vertex.vs";
	std::string fsPath = "./work/ShaderFile/CubeMap/CubeReflect/fragment.fs";
	...
	vsPath = "./work/ShaderFile/CubeMap/ObjectReflect/vertex.vs";
	fsPath = "./work/ShaderFile/CubeMap/ObjectReflect/fragment.fs";
	MyShader objShader(vsPath.data(), fsPath.data());

	vsPath = "./work/ShaderFile/CubeMap/CubeRefract/vertex.vs";
	fsPath = "./work/ShaderFile/CubeMap/CubeRefract/fragment.fs";
	MyShader CubeRefractShader(vsPath.data(), fsPath.data());

	vsPath = "./work/ShaderFile/CubeMap/ObjectRefract/vertex.vs";
	fsPath = "./work/ShaderFile/CubeMap/ObjectRefract/fragment.fs";
	MyShader objRefractShader(vsPath.data(), fsPath.data());
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform1i(glGetUniformLocation(CubeShader.ID, "skybox"), 0);
		glUniform3f(glGetUniformLocation(CubeShader.ID, "cameraPos"), myCamera.Position.x, myCamera.Position.y, myCamera.Position.z);
		view = myCamera.GetViewMatrix();
