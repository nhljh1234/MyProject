...
int main()
{
	...
	std::string vsPath = "./work/ShaderFile/Light/AmbientLighting/lamp/vertex.vs";
	std::string fsPath = "./work/ShaderFile/Light/AmbientLighting/lamp/fragment.fs";
	MyShader lampShader(vsPath.data(), fsPath.data());

	vsPath = "./work/ShaderFile/Light/AmbientLighting/toy/vertex.vs";
	fsPath = "./work/ShaderFile/Light/AmbientLighting/toy/fragment.fs";
