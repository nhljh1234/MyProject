...
int main()
{
	...
	std::string vsPath = "./work/ShaderFile/RimLight/vertex.vs";
	std::string fsPath = "./work/ShaderFile/RimLight/fragment.fs";
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(objShader.ID, "RimLightColor"), 1.0, 0.0, 0.0);
