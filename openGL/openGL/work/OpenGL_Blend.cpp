...
int main()
{
	...
	imgPath = "./img/window.png";
	unsigned int windowTexture = loadTexture(imgPath.data(), GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE);

	std::string vsPath = "./work/ShaderFile/Blend/Cube/vertex.vs";
	std::string fsPath = "./work/ShaderFile/Blend/Cube/fragment.fs";
	MyShader CubeShader(vsPath.data(), fsPath.data());

	vsPath = "./work/ShaderFile/Blend/Grass/vertex.vs";
	fsPath = "./work/ShaderFile/Blend/Grass/fragment.fs";
