...
int main()
{
	...
	std::string vsPath = "./work/ShaderFile/Dissolution/vertex.vs";
	std::string fsPath = "./work/ShaderFile/Dissolution/fragment.fs";
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform1f(glGetUniformLocation(objShader.ID, "num"), num);
